...
namespace glob {
	...
	namespace offsets
	{
		...
		const static DWORD GlobalVars = 0x004F02D0;
		const static DWORD m_vecOrigin = 0x134;
		const static DWORD m_iCrosshairID = 0x2410;
		const static DWORD m_dwEntityList = 0x04A22534;
		const static DWORD m_iHealth = 0xfc;
		const static DWORD m_dwGlowObject = 0x04B357D4;
		...
		const static DWORD m_dwClientState = 0x005D0224;
